...
public class fragment extends Fragment {
    ...
    public String loadURL()
    {
        String urltemp="";
        if(pos == 0 )
            urltemp = "http://newsapi.org/v2/everything?q=apple&from=2020-10-21&to=2020-10-21&sortBy=popularity&apiKey=a4f528c02600408496a4278e9aec04df";
        else if (pos == 1)
            urltemp = "http://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=a4f528c02600408496a4278e9aec04df";
        else if(pos == 2)
            urltemp = "http://newsapi.org/v2/everything?domains=wsj.com&apiKey=a4f528c02600408496a4278e9aec04df";
        else
            urltemp = "http://newsapi.org/v2/everything?q=bitcoin&from=2020-09-22&sortBy=publishedAt&apiKey=a4f528c02600408496a4278e9aec04df";
        return urltemp;
    }
}